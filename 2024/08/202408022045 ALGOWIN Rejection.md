...
You write that C_i and C_{i-1} have cost 1 at time i for i=n+1..2n. This would indicate that we have vertices C_i for i=n..2n. 
...
*This was an important flaw - changed by not adding "prongs" to variable vertices not in the formula.*
